...
} from './rich-text-editor.module';

import {
  RichTextEditorFixtureComponent
} from './fixtures/rich-text-editor.component.fixture';
...
import { SkyRichTextEditorManagementService } from './services/rich-text-editor-management.service';

describe('Rich text editor', () => {
  let fixture: ComponentFixture<RichTextEditorFixtureComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RichTextEditorFixtureComponent);
  });
  ...
  it('Should return blank documents for non-existant documents', () => {
    const mngService = TestBed.inject(SkyRichTextEditorManagementService);
